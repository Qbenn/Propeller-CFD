...
\clearpage
	...
	Metoda BEMT (\textit{Blade Element Momentum Theory}) stanowi połączenie teorii elementu łopatkowego z jednowymiarową teorią pędu. W podejściu tym łopatę śmigła dzieli się wzdłuż promienia na dyskretne odcinki pierścieniowe. Dla każdego z przekrojów wyznacza się obciążenia aerodynamiczne w oparciu o lokalne warunki napływu i charakterystyki zastosowanego profilu, podczas gdy ogólny bilans pędu w tarczy śmigła umożliwia określenie prędkości indukowanych w strudze.
	...
	\begin{table}[H]
		...
		\begin{tabular}{@{}c c c c c@{}}
			...
			25 & +5,4   & -165,9 & +4,8   & 0,0   \\
			30 & +71,5  & +6,6   & +71,5  & 0,0   \\
			\bottomrule
		\end{tabular}
	\end{table}
